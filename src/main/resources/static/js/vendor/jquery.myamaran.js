(function() {
  (function($, window, document, undefined_) {
    ...
    themes = {
      ...
      kindleTheme: function(data) {
          return "<a href='/items/" + data.asin + "' target='_blank'><div class=\"icon\"><img src=\"" + data.img + "\" alt=\"\" /></div><div class=\"info\"><b>" + data.title + "</b><br /><p>" + data.message + "</p></div></a>";
        },
